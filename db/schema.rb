...
ActiveRecord::Schema.define(version: 20140815112627) do
  ...
  create_table "project_image_attachments", force: true do |t|
    t.integer  "project_id"
  ...
  create_table "project_tag_maps", force: true do |t|
